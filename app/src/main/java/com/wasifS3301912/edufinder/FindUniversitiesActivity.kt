...
fun TopSchoolsList(
    ...
    val allPlaces = getUniversityDetails()
...
fun getUniversityDetails(): List<UniversityDetails> {
    return listOf(
        UniversityDetails(
            ...
            universityImage = R.drawable.harvard_university,
        ...
        UniversityDetails(
            ...
            universityImage = R.drawable.stanford_university,
        ...
        UniversityDetails(
            ...
            universityImage = R.drawable.oxford_university,
